...
instance
  ...
  SimpleMergeable (SymSeq sa)
  where
  mrgIte (SymBool c) (SymSeq t) (SymSeq f) = SymSeq $ pevalITETerm c t f
...
instance
  ...
  SimpleMergeable (SymNominal domain value)
  where
  mrgIte (SymBool c) (SymNominal t) (SymNominal f) =
